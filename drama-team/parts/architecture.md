...
7. **🔥 竖屏视觉语法（v3.7 ⭐ 新增）** — 竖屏(9:16)与横屏(16:9)的视觉语法根本不同，必须专门设计：
   - **纵向视线引导**：利用竖屏纵向空间，从上→下引导视线（如：顶部悬念元素→中部角色→底部揭示），横屏的左右构图法不适用
   - **画外空间叙事**：竖屏上下画外空间比左右更大，角色"看向画外上方/下方"比"看向画外左侧"更有悬念感
   - **文字叠加叙事**：竖屏文字叠加（短信/字幕/倒计时）比横屏更自然（横屏文字遮挡画面主体，竖屏文字可在上下留白区）
   - **竖屏亲密空间**：竖屏天然适合双人半身构图（上半身占满画幅），比横屏更有压迫感和亲密感
