...
├── outline.md                   # 故事大纲（含 project_type + ep_duration + paywall_ep + 总集数 配置）
├── continuity.md                # 剧集连续性追踪（叙事）
├── visual_continuity.md         # 视觉连续性追踪（每集分镜完成后更新）
├── skeleton/                    # 骨架模式（可选，阶段4a）：EP-XX.md + skeleton_continuity.md
├── characters/
